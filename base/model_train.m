...
switch encoder.type
    ...
    case 'g2denet'
        code_ = get_g2denet_features(encoder.net, im, 'scales', scale);
end
result.code = code_ ;
...
switch opts.type
   ...
   case {'bcnn','g2denet'}
       encoder.normalization = opts.normalization;
        ...
        if strcmp(opts.type,'g2denet')
            encoder.neta.layers = encoder.neta.layers(1:end-2);
        end
